...
def inc_counter(): #this function will increment the request counter
	global request_counter
	request_counter+=9999

def set_flag(val): #this function will set the flag to 1
	global flag
	flag=val

def set_safe(): #this function will set the safe variable to 1
	global safe
	safe=1	
# generates a user agent array
def useragent_list(): #this function will generate a list of user agents for the script to use when sending requests
